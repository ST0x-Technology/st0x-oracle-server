...
async fn build_response_from_quote_pair_bound(
    ...
    // v5/v6/v7: if the previous signature for this pair states the same price
    ...
    let fingerprint = reuse::Fingerprint {
        ...
        nav_ratio: match schema {
            ...
            PairSchema::V4 | PairSchema::V5 | PairSchema::V7 => FixedBytes::<32>::ZERO,
        },
    };
    let signs_expiry = matches!(schema, PairSchema::V5 | PairSchema::V6 | PairSchema::V7);
    if signs_expiry {
